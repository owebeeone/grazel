...
mod materialize; // crate-universe P2.5/P2.6: @crates root write + per-crate RepoFetch
mod native_cc;
...
mod stale; // crate-universe P2.3: stale-lock detection (rehash FILE workspace inputs)
mod provider_values;
mod registry;
pub mod rules;
mod selects;
