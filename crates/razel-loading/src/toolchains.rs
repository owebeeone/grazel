...
pub(crate) fn toolchain_rows<'v>(
    ...
    let rust = heap.alloc(AllocStruct([
        ...
        ("all_files".to_string(), heap.alloc(crate::values::Depset { direct: Vec::new(), transitive: Vec::new() })),
    ...
    let cc = heap.alloc(AllocStruct([
        ...
        ("_strip_files".to_string(), heap.alloc(crate::values::Depset { direct: Vec::new(), transitive: Vec::new() })),
        ("_coverage_files".to_string(), heap.alloc(crate::values::Depset { direct: Vec::new(), transitive: Vec::new() })),
        ...
        ("all_files".to_string(), heap.alloc(crate::values::Depset { direct: Vec::new(), transitive: Vec::new() })),
        ("linker_files".to_string(), heap.alloc(crate::values::Depset { direct: Vec::new(), transitive: Vec::new() })),
        ("_linker_files".to_string(), heap.alloc(crate::values::Depset { direct: Vec::new(), transitive: Vec::new() })),
