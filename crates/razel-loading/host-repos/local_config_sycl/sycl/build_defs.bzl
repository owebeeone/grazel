# razel host materialization of @local_config_sycl//sycl:build_defs.bzl — generator tpl
# (xla/third_party/gpus/sycl/build_defs.bzl.tpl), NO-SYCL fills (sycl_configure.bzl:438).
