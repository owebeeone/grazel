# razel host materialization of @local_config_rocm//rocm:build_defs.bzl — the generator's
# template (xla/third_party/gpus/rocm/build_defs.bzl.tpl) with its NO-ROCM substitutions
# (rocm_configure.bzl:260). CPU-only host.
...
def if_rocm_is_configured(if_true, if_false = []):
    ...
    """
    return if_true if False else if_false
